...
#Figure 3
ggsave(filename = "barplot_class_allsamples_hormone_resus_ABA_SA_04.10.25.pdf", figure, ##CHANGED FILE NAMES AS NEEDED
       width = 160,
       height = 100, units = c("cm"),
       dpi = 300, limitsize = FALSE)
...
ggsave(filename="pcoa-sw-sa-withOUT-mesocosmeffect-constrained.TIFF", plot=pcoa_sw_sa, width=6.8, height=6, units="in", dpi=720)
ggsave(filename="pcoa-sw-aba-withOUT-mesocosmeffect-constrained.TIFF", plot=pcoa_sw_aba, width=6.8, height=6, units="in", dpi=720)
ggsave(filename="pcoa-bean-sa-withOUT-mesocosmeffect-constrained.TIFF", plot=pcoa_bean_sa, width=6.8, height=6, units="in", dpi=720)
ggsave(filename="pcoa-bean-aba-withOUT-mesocosmeffect-constrained.TIFF", plot=pcoa_bean_aba, width=6.8, height=6, units="in", dpi=720)
